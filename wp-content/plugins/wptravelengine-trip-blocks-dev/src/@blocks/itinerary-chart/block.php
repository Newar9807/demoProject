...
if ( ! defined( 'WTEAI_VERSION' ) ) {
	?>
	<div class="notice">
		<?php echo esc_html__( 'Please activate WP Travel Engine - Advanced Itinerary addon for this block to work.' ); ?>
	</div>
	<?php
} else {
	...
	<div <?php echo $attributes_parser->wrapper_attributes(); ?>>
		<div class="altitude-chart-container">
			...
			<?php } else { ?>
				<div class="notice">
					<?php echo esc_html__( 'Please add some Trip Itinerary Altitude data for this trip.' ); ?>
				</div>
			<?php } ?>
		</div>
	</div>
