...
const FileUpload = ({ value, onChange, wpMediaUploader, buttonLabel, ...ControlContainer }) => {
    ...
    return <FileUploadStyle>
        {value?.url && (
            <div className="cw__media-preview">
                <img src={value.url} />
                <button type="button" onClick={handleRemoveImage} className="cw__media-remove-button">
                    {Icons.timesCircle}
                </button>
            ...
            !value?.url && <>
                {
                    wpMediaUploader && (
                        ...
                        <FormFileUpload value={value} onChange={val => onChange(val)} {...ControlContainer}>
                            {Icons.upload}
                            {buttonLabel || "Upload"}
                        </FormFileUpload>
                    )
...
export default (props) => {
    return ControlContainer(FileUpload)(props)
}